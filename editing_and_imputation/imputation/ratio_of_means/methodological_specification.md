...
When the imputation link is multiplied by the predictive record, the predictive
...
imputation links for more than one period. In the simplest case this could be the
